...
function showCustomToast(titulo, mensagem, url, hora) {
	...
	toast.innerHTML = `
				<div class="user-avatar user-avatar-rounded online">
					<img src="/acesso/images/client13.png" alt="" style="filter: blur(5px);width: 32px;height: 52px;">
				</div>
...
function initSound() {
	audio = new Audio("/acesso/sounds/375962348932703.mp3"); // seu arquivo
	...
	$("#personal-chat .userSearchList").prepend(`
		<li>
			<div class="conversation-main-new">
				<div class="user-avatar user-avatar-rounded online">
					<img src="/acesso/images/client13.png" alt="" style="filter: blur(5px);">
				</div>
				<div class="conversation__details">
					...
					<div class="conversation__message">
						<div class="conversation__message-preview">
							<span class="tick">
								<img src="/acesso/images/tickread.svg" alt="">
							</span>
							<span>
								Lembrando de você 🤤🤤😈
							</span>
